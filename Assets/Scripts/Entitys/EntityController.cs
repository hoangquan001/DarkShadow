...
public class EntityController : MonoBehaviour
{
    ...
    public EtityFace Face = EtityFace.Right;
    public bool Grounded { get; protected set; }


    private EntityAttribute _attributes;
    ...
    {
        _attributes = GetComponent<EntityAttribute>();
    ...
    public virtual void Rotation(int direct)
    {
        transform.rotation = Quaternion.Euler(0, direct > 0 ? 0 : 180, 0);
        this.Face = direct > 0 ? EtityFace.Right : EtityFace.Left;
    }
